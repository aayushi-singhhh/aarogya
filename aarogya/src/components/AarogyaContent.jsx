  ...
  return (
    <>
      <div className="hero_illustration_block" style={{ position: "relative", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "top", justifyContent: "center", overflow: "hidden", paddingTop: 0 }}>
        {/* Custom content above nav.navigation */}
        <div style={{ width: '100%', background: 'rgba(0,0,0,0.7)', color: 'white', textAlign: 'center', padding: '0.5rem 0', zIndex: 2100, position: 'absolute', top: 0, left: 0 }}>
        ...
        <div className="w-layout-blockcontainer container w-container" style={{ position: "relative", zIndex: 10, display: 'flex', alignItems: 'flex-start', justifyContent: 'flex-start' }}>
          <div style={{ flex: 1 }}>
            <div className="h2" style={{ color: "white", textAlign: "left", textTransform: "uppercase", marginLeft: "auto", marginRight: "auto", fontFamily: 'Founders Grotesk Condensed, Impact, sans-serif', fontSize: "100px", fontWeight: 700, lineHeight: "70%", overflow: "visible" }}>
              WELCOME <br />TO PLANET AAROGYA
            </div>
            <p className="paragraph-light discoveries" style={{ textAlign: "left", width: "55%", maxWidth: "650px", marginLeft: "auto", marginRight: "auto", fontFamily: 'Cardinalfruitweb, Times New Roman, sans-serif', fontSize: "32px", lineHeight: "110%" }}>
